...
<body>
  ...
  <div class=""align="center">
    <img src="images/ClipartKey_194631.png" ALT="some text" WIDTH=110 HEIGHT=100>
  ...
  <div class=""align="center">
    ...
    <ul style="list-style:none;">
        ...
        <br>
  <div class=""align="center">
    <img src="images/ClipartKey_1163212.png" ALT="some text" WIDTH=100 HEIGHT=100>
    <ul style="list-style:none;">
    	<br><br>
        ...
        <br><br>
            <br>
  <div class=""align="center">
    <img src="images/ClipartKey_534357.png" ALT="some text" WIDTH=100 HEIGHT=100>
    <ul style="list-style:none;">
    	<br><br>
  ...
  <div class=""align="center">
	...
	<div id="sideNav">
        ...
        <li><a href="donation.php">Proceed to Donation</a></li>
